...
category_labels <- c("-2" = "Strong Decline", 
                     "-1" = "Decline", 
                     "0" = "Stable", 
                     "1" = "Increase")
...
write.csv(results_full, "pixel_counts_full_extent.csv", row.names = FALSE)
write.csv(results_cz, "pixel_counts_czech_republic.csv", row.names = FALSE)

# Save plots
ggsave("pixel_counts_full_extent.png", p1, width = 12, height = 8, dpi = 300)
ggsave("pixel_counts_czech_republic.png", p2, width = 12, height = 8, dpi = 300)
ggsave("percentage_comparison.png", p3, width = 12, height = 10, dpi = 300)
ggsave("category_distribution_comparison.png", p4, width = 10, height = 8, dpi = 300)
